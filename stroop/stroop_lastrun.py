...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/mridul/Documents/CPSY_Project/stroop/stroop.psyexp',
...
instrText = visual.TextStim(win=win, name='instrText',
    text='STROOP TASK\n\nRemember, choose the color of the letters ignoring the word\n\nleft = red\ndown = green\nright = blue',
    font='Arial',
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if response.status == STARTED:
            theseKeys = event.getKeys(keyList=['down', 'left', 'right'])
